...
public class FemaleZombieVillagerModel<T extends LivingEntity> extends HumanoidModel<T> {

    public static final ModelLayerLocation LAYER_LOCATION =
            new ModelLayerLocation(
                    ResourceLocation.fromNamespaceAndPath("slimpatch", "female_zombie_villager"),
                    "main"
            );

    public FemaleZombieVillagerModel(ModelPart root) {
        super(root);
    }
