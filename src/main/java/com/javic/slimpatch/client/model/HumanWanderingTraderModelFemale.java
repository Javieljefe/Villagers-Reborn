...
public class HumanWanderingTraderModelFemale<T extends LivingEntity> extends HumanoidModel<T> {

    public static final ModelLayerLocation LAYER_LOCATION =
            new ModelLayerLocation(
                    ResourceLocation.fromNamespaceAndPath("slimpatch", "human_trader_female"),
                    "main"
            );

    public HumanWanderingTraderModelFemale(ModelPart root) {
        super(root);
    }
